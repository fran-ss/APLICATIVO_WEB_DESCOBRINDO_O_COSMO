    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    searchBox = _a.sent();
                    return [4 /*yield*/, searchBox.sendKeys('Selenium', selenium_webdriver_1.Key.RETURN)];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, driver.wait(selenium_webdriver_1.until.titleContains('Selenium'), 5000)];
                case 6:
                    _a.sent();
                    return [3 /*break*/, 9];
